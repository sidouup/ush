...
# Use Streamlit secrets for service account info and passwords
...
# Existing functions (get_google_sheet_client, load_data, calculate_visa_approval_rate) remain unchanged
    ...
    if check_password():
        ...
        <div style="display: flex; justify-content: center; align-items: center; height: 100vh;">
            <div style="text-align: center;">
                <img src="https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=297,h=404,fit=crop/YBgonz9JJqHRMK43/blue-red-minimalist-high-school-logo-9-AVLN0K6MPGFK2QbL.png" style="width: 150px; margin-bottom: 20px;">
                <h1 style="color: #1E3A8A;">Welcome to The Us House Dashboard</h1>
                <p style="color: #6B7280;">Please log in to access the dashboard.</p>
            </div>
        </div>
        """, unsafe_allow_html=True)
