...
rule_3a = data[(data['EMBASSY ITW. DATE'] > today) & (data['EMBASSY ITW. DATE'] <= today + timedelta(days=7)) & (data['Stage'] != 'CLIENT')].sort_values(by='EMBASSY ITW. DATE').reset_index(drop=True)
